...
namespace LoadTest.Data
{
 ...
 // E variant entities (43)
        ...
        public virtual DbSet<ExtraEntity1E> ExtraEntity1E { get; set; }

        // Extra entities (7)
        public virtual DbSet<ExtraEntity2> ExtraEntity2 { get; set; }
        public virtual DbSet<ExtraEntity3> ExtraEntity3 { get; set; }
        public virtual DbSet<ExtraEntity4> ExtraEntity4 { get; set; }
        public virtual DbSet<ExtraEntity5> ExtraEntity5 { get; set; }
        public virtual DbSet<ExtraEntity6> ExtraEntity6 { get; set; }
        public virtual DbSet<ExtraEntity7> ExtraEntity7 { get; set; }
        public virtual DbSet<ExtraEntity8> ExtraEntity8 { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VW_ExpenseWithTransportationE>().HasNoKey().ToView("VW_ExpenseWithTransportationE");
            modelBuilder.Entity<VW_CapitalProfitReportE>().HasNoKey().ToView("VW_CapitalProfitReportE");
        }
        ...
        private void ConfigureDecimalPrecision(ModelBuilder modelBuilder)
        {
            ...
            // E variant entities
            modelBuilder.Entity<ProductE>().Property(p => p.SellingPrice).HasPrecision(18, 2);
            modelBuilder.Entity<CustomerE>().Property(c => c.TotalAmount).HasPrecision(18, 2);
        }
    }
}