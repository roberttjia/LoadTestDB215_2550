...
A comprehensive SQL Server database stress test with **215 entities** and **2550+ columns** designed for testing database migration tools, ORM performance, and system scalability.
...
2. **Configure Connection String**
   ...
   {
     "ConnectionStrings": {
       "DefaultConnection": "Server=YOUR_SERVER;Database=LoadTestDb215_2550;User Id=YOUR_USER;Password=YOUR_PASSWORD;TrustServerCertificate=true;MultipleActiveResultSets=true"
     }
   }
   ```
...
- **EF Core Model**: Complete Entity Framework Core model with all 215 entities
...
- **Memory Usage**: Extreme
- **EF Core Compatibility**: Excellent

## 🎯 Use Cases

### Migration Tool Testing
- **Extreme Testing**: Perfect for limit testing
...
- **Entity Framework**: Validate EF Core performance with 215 entities
